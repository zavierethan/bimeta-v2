...
<div class="content content--top-nav">
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <h2 class="text-2xl font-extrabold dark:text-primary">Master Data Customer</h2>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3"
                                    href="{{route('master.customer.edit', ['id' => $item->id])}}"> <i data-lucide="edit"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="intro-y box">
                            ...
                            <div id="horizontal-form" class="p-5">
                                <form method="POST" action="{{route('master.customer.save')}}">
                                    @csrf
                                    <div id="horizontal-form" class="p-5">
                                        <div class="preview">
                                            ...
                                            <div class="form-inline mt-5">
                                                ...
                                                <select data-placeholder="Pilih PIC"
                                                    ...
                                                    <option value=" ">-</option>
                                                    @foreach($pic as $pic)
                                                    <option value="{{$pic->username}}">{{$pic->display_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-inline mt-5">
                                            ...
                                            <div class="form-inline mt-5">
                                                <label for="vertical-form-1" class="sm:w-32 font-bold">Tipe
                                                    Pajak</label>
                                            ...
                                            <div class="form-inline mt-5">
                                                ...
                                                <select data-placeholder="Pilih Tipe Pajak" class="tom-select w-full form-control" name="customer_type">
                                                    <option value=" ">-</option>
